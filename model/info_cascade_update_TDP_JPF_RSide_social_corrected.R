...
ppb_4_2 <- transform(ppb_4_2, P_Prop = "0.5 (50% propagation)")
...
ppb_5_2 <- transform(ppb_5_2, P_Prop = "0.5 (50% propagation)")
...
ppb_6_2 <- transform(ppb_6_2, P_Prop = "0.5 (50% propagation)")
...
ppb_7_2 <- transform(ppb_7_2, P_Prop = "0.1 (10% propagation)")
...
ppb_8_2 <- transform(ppb_8_2, P_Prop = "0.1 (10% propagation)")
...
ppb_9_2 <- transform(ppb_9_2, P_Prop = "0.1 (10% propagation)")
