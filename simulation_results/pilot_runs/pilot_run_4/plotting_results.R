...
cascade_model_BSCM_pilot <- data.frame(read.csv('~/Desktop/phd_update_october/paper_projects/information_cascade_TDP_JPF/modelling/simulation_results/pilot_run_5/cascade_model_BSCM_pilot_5_social_influence.csv'))
